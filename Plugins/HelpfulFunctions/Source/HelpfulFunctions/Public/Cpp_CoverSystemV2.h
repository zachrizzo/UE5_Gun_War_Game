...
struct FCoverTraceStartConfig
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FVector2D VelocityOffsetScale = FVector2D(1.0, 2.0);
};
...
protected:
	...
	UPROPERTY(BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "CoverSystem", DisplayName = "CurrentActorRotation"))
		FRotator CurrentActorRotationC = FRotator(0, 0, 0);
...
public:	
	...
	UFUNCTION(BlueprintNativeEvent, Category = "CoverSystem", meta = (DisplayName = "Set Current Actor Rotation", Keywords = "Cover System"))
		bool SetCurrentActorRotation();

	virtual bool SetCurrentActorRotation_Implementation();
