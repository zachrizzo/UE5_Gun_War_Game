...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "JakubW_FunctionsLibrary| Actor", meta = (WorldContext = "WorldContextObject", Keywords = "Actor,Save"))
	...
	UFUNCTION(BlueprintCallable, Category = "JakubW_FunctionsLibrary| Actor", meta = (WorldContext = "WorldContextObject", Keywords = "Actor,Component,Arrow"))
	...
	/**
	* Interpoluje liniowo pomiedzy punktami w tablicy.
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "JakubW_FunctionsLibrary| Interpolation", meta = (Keywords = "Math,Interpolation,Points"))
	static FVector InterpolateBetweenPoints(const TArray<FVector>& Points, float Alpha);


	UFUNCTION(BlueprintPure, Category = "JakubW_FunctionsLibrary| Character", meta = (Keywords = "Math,Character,Time,Distance"))
